...
const uint8_t CONV_UIDS[][7] = {
  ...
  {0x04, 0x2B, 0xC3, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xC2, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xC1, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xBF, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xC0, 0xAA, 0x96, 0x20, 0x91},
};
const uint8_t FISH_UIDS[][7] = {
  {0x04, 0x2B, 0xA2, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xA0, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xC4, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xC5, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xCB, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xCD, 0xAA, 0x96, 0x20, 0x91},
  {0x04, 0x2B, 0xCC, 0xAA, 0x96, 0x20, 0x91},
};
#define CONV_COUNT 7
#define FISH_COUNT 7
